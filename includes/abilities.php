...
function mcp_abilities_gutenberg_register_abilities(): void {
	...
	mcp_abilities_gutenberg_register_ability(
		...
		array(
			'label'               => 'Validate Devenia Editorial Post',
			'description'         => 'Validate a Devenia source post against the approved native GeneratePress/GenerateBlocks editorial post guardrails.',
			'category'            => 'block-editor',
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(
			...
			'execute_callback'    => function ( $input = array() ): array {
				...
				return array(
					'success'    => true,
					'message'    => ! empty( $validation['passed'] ) ? 'Devenia editorial post validation passed.' : 'Devenia editorial post validation found issues.',
